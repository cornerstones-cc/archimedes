...
@TinyId(bizType = DataPageDo.RESOURCE_NAME, beginId = 100, maxId = 100, step = 100, remainder = 0, delta = 1)
@EqualsAndHashCode(callSuper = false)
@Data
@Entity
@Table(name = DataPageDo.RESOURCE_NAME)
@Where(clause = "is_deleted=0")
public class DataPageDo extends BaseDo {
    public static final String RESOURCE_NAME = "a1_dp_data_page";
    public static final String RESOURCE_SYMBOL = "Data page";
