...
@TinyId(bizType = AuthenticationServiceComponentDo.RESOURCE_NAME, beginId = 100, maxId = 100, step = 100, remainder = 0
        , delta = 1)
@EqualsAndHashCode(callSuper = false)
@Data
@Entity
@Table(name = AuthenticationServiceComponentDo.RESOURCE_NAME)
@Where(clause = "is_deleted=0")
public class AuthenticationServiceComponentDo extends BaseDo {
    public static final String RESOURCE_NAME = "k3_authentication_svc_component";
    public static final String RESOURCE_SYMBOL = "Authentication service component";
     ...
     */
    @Type(type = "json")
    @Column(name = "user_info_schema", columnDefinition = "json")
