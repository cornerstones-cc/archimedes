...
@Component
public class ClickhouseDmlHandler implements DmlHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(ClickhouseDmlHandler.class);
    ...
    public QueryResult loadSampleDataOfDataTable(
        ...
        sql.append("SELECT * FROM ")
                .append(AbcClickhouseUtils.buildEscapedName(databaseName)).append(".").append(AbcClickhouseUtils.buildEscapedName(dataTableMetadata.getName()))
                .append(" LIMIT 0, 100");
    ...
    public ParseResult parseQuery(
            DataSourceConnection connection,
            String queryStatement) throws AbcUndefinedException {
        SQLStatement sqlStatement = SQLUtils.parseSingleStatement(queryStatement, DbType.clickhouse);
