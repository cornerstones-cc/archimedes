 ...
 * @author bbottong
 */
@TinyId(bizType = GroupDo.RESOURCE_NAME, beginId = 100, maxId = 100, step = 100, remainder = 0, delta = 1)
@EqualsAndHashCode(callSuper = false)
@Data
@Entity
@Table(name = GroupDo.RESOURCE_NAME)
@Where(clause = "is_deleted=0")
public class GroupDo extends BaseDo {
    public static final String RESOURCE_NAME = "k2_group";
    public static final String RESOURCE_SYMBOL = "Group";
