...
@Component
public class MysqlDmlHandler implements DmlHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(MysqlDmlHandler.class);
    ...
    public QueryResult loadSampleDataOfDataTable(
        ...
        sql.append("SELECT * FROM ")
                .append(AbcMysqlUtils.buildEscapedName(databaseName)).append(".").append(AbcMysqlUtils.buildEscapedName(dataTableMetadata.getName()))
                .append(" LIMIT 0, 100");
    ...
    public ParseResult parseQuery(
            DataSourceConnection connection,
            String queryStatement) throws AbcUndefinedException {
        SQLStatement sqlStatement = SQLUtils.parseSingleStatement(queryStatement, DbType.mysql);
