...
/**
 * Data permission service component
 *
 * @author bbottong
 */
@TypeDef(name = "json", typeClass = JsonStringType.class)
@TinyId(bizType = DataPermissionServiceComponentDo.RESOURCE_NAME, beginId = 100, maxId = 100, step = 100, remainder = 0
        , delta = 1)
@EqualsAndHashCode(callSuper = false)
@Data
@Entity
@Table(name = DataPermissionServiceComponentDo.RESOURCE_NAME)
@Where(clause = "is_deleted=0")
public class DataPermissionServiceComponentDo extends BaseDo {
    public static final String RESOURCE_NAME = "k3_data_permission_svc_component";
    public static final String RESOURCE_SYMBOL = "Data permission service component";
