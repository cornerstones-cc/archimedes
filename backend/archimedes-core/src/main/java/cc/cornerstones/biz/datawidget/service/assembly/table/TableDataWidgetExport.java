...
@Data
public class TableDataWidgetExport {
    /**
    ...
    public static void main(String[] args) {
        TableDataWidgetExport query = new TableDataWidgetExport();
        ...
        query.setExportOption(ExportOptionEnum.EXPORT_AS_TEMPLATE);

        query.setExportExtendedTemplateUid(12L);
