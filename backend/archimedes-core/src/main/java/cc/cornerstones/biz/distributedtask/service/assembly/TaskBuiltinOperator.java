...
public class TaskBuiltinOperator extends TaskOperator {
    private final Object underlyingObject;
    private final Method coreMethod;
    private Method initMethod;
    private Method destroyMethod;

    public TaskBuiltinOperator(Object underlyingObject, Method coreMethod, Method initMethod, Method destroyMethod) {
