...
@Component
public class PostgresqlDmlHandler implements DmlHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(PostgresqlDmlHandler.class);
    ...
    public QueryResult loadSampleDataOfDataTable(
        ...
        sql.append("SELECT * FROM ")
                .append(AbcPostgresqlUtils.buildEscapedName(databaseName)).append(".").append(AbcPostgresqlUtils.buildEscapedName(dataTableMetadata.getName()))
    ...
    public ParseResult parseQuery(
            DataSourceConnection connection,
            String queryStatement) throws AbcUndefinedException {
        SQLStatement sqlStatement = SQLUtils.parseSingleStatement(queryStatement, DbType.postgresql);
    ...
    public QueryResult testQuery(
        ...
        wrapperSql.append("SELECT * FROM (")
                ...
                .append(" LIMIT ").append(limit).append(" OFFSET 0");
