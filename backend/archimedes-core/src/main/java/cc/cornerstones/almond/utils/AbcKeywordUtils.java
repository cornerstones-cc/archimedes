...
public class AbcKeywordUtils {
    public static final List<String> MYSQL_KEYWORDS = Arrays.asList(new String[]{
            "accessible", "add", "all ", "alter",
            "analyze", "and ", "as", "asc", "asensitive ", "before", "between", "bigint ", "binary", "blob", "both ",
            ...
            "float8", "for", "force ", "foreign", "from", "fulltext ", "get", "grant", "group ", "having",
    ...
    public static final List<String> SQLSERVER_KEYWORDS = Arrays.asList(new String[]{
